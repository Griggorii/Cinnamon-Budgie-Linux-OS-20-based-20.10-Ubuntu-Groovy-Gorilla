...
1) OS20 19.10 2)      OS19 19.04      3) OS8.0 18.10
...
----------------------------------------------------------------------------------------------------------------------------
3) Cinnamon Budgie OS8.0 18.10 iso 3,9Гб https://yadi.sk/d/zFinAWQMsDXCYA с java машинамм уже готовыми для работы с java и snapd в более верхних новых дистрибутивах придется устанавливать официальное ядро которое будет подерживать snap и dkms что бы крутить тот же anbox
