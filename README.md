...
мержится в opt у меня это делает var при том что он там компилирует даже джаву и котлин. Сама система в которую я ещё раз повторяю вытащил из 16.04 java машину и всю по частям перенес это OS 8.0 18.10 скачать её можно ниже https://github.com/Griggorii/Cinnamon-Budgie-OS-4.0-beta-based-18.04/blob/master/README.md страницу надо промотать вниз.
