...
1) OS20 19.10 2) OS19 19.04 3) OS8.0 18.10 upstart-OS8.0_Demo_Griggorii.tar.bz2 поддерживается только в этой системе все отличающиеся операционные системы не поддерживатся и сломаются до не восстанавливаемого для новичка состояния.
