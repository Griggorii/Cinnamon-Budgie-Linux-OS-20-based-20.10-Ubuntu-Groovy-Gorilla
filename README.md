...
Если вы считаете что эта система плохая и нужно ставить с ноля то делайте , а потом заидите после установки в /lib/systemd/system и проверьте есть ли там битые ссылки и наверное бу
