...
или Cinnamon Budgie OS19 19.04 для тех кому нужен nemo который не прячет меню , но ест побольше чем новый 19.10 но iso 3Гб https://yadi.sk/d/IQ2t0KyyWxmg4A nemo имеет такую функцию https://github.com/Griggorii/Linux_Nemo_find_type_file_fix_by_griggorii/blob/master/Nemo_find.flv
