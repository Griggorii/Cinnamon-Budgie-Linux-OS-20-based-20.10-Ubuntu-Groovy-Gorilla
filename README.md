...
в системах с systemctl будет нечто подобное типа  sudo systemctl network-manager restart я иногда сам путался и мог выкидывать рабочии версии ядра из за того что их не проверял.
______________________________________________________________________________________________________________________
