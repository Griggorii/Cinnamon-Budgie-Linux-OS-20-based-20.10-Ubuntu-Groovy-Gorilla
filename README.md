...
java version "1.8.0_201" Внимание системные репы куда то исчезли уже с где то с 19 февраля возможно они поняли что это лучшая ось за счёт того что не ломается от сраных suda make install вообщем форкаем под моим ником и тянем мою ось не даром я тогда говорил что я её смешивал и регулятор регулировки яркости рабочии даже в budgie окружении. Так же подготовленна новая графика тут готовый пакет или сорцы https://github.com/Griggorii/mesa-13.0.4_V2_source_by_Griggorii_tutorial_patent_compilation т.е работа из за отсутствия реп заморозилась видимо пересматривают и понимают что это операционная система лучшая по этому все репы отняли что бы не смогли билдить на этой смешанной системе , пришлось временно curl4 на curl3 переключить. Короче опять не тем зарплату платят надеюсь это не макеры там замахнулись купить эту ось что бы в свою перемаркировать. Видимо графику можно ускорить с моим пакетом /etc/ld.so.conf.d надо будет перебить конфиги на расположение драиверов mesa так как те направленны на старую mesa от 16.04 который я разрабатывал очень давно и был на основе linux lite который позднее превратился в пеперминт.
