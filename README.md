...
Мной создано ядро V11 которое не будет выпадать в initramfs если вы поставите систему за другую систему будь то sda3 , sda4 
и далее в OS14 я уже его установил. Все остальные ядра менее стабильные и могут испортить систему.
______________________________________________________________________________________________________________________
