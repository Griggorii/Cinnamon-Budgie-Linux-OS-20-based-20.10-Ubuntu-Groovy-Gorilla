...
После установки если опять заидёт в root то не перезагружаясь выйдите верхнем самом правом углу нажмите на значек и выбирите budgie , cinnamon  или окружение которое до этого знали загружаться из гостевой сессии это будет долго так как флешка , на рабочем столе жмём Установить RELEASE и пароль 123 если .
